...
export class Migrations1734482369542 implements MigrationInterface {
  name = 'Migrations1734482369542';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`userId\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD UNIQUE INDEX \`IDX_e0208b4f964e609959aff431bf\` (\`userId\`)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_e0208b4f964e609959aff431bf\` ON \`students\` (\`userId\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP FOREIGN KEY \`FK_e0208b4f964e609959aff431bf9\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP FOREIGN KEY \`FK_aa8edc7905ad764f85924569647\``,
    );
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_e0208b4f964e609959aff431bf\` ON \`students\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` CHANGE \`matricNo\` \`matricNo\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD CONSTRAINT \`FK_aa8edc7905ad764f85924569647\` FOREIGN KEY (\`school_id\`) REFERENCES \`schools\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP INDEX \`IDX_e0208b4f964e609959aff431bf\``,
    );
