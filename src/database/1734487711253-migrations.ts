...
export class Migrations1734487711253 implements MigrationInterface {
  name = 'Migrations1734487711253';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`staffs\` CHANGE \`surname\` \`middlename\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`staffs\` DROP COLUMN \`middlename\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`staffs\` ADD \`middlename\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`staffs\` CHANGE \`middlename\` \`surname\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
