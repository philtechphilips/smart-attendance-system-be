...
export class Migrations1734955960797 implements MigrationInterface {
  name = 'Migrations1734955960797';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`courses\` ADD \`departmentId\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`courses\` ADD \`programId\` varchar(36) NULL`,
    );
    await queryRunner.query(
