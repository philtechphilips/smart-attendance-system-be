...
export class Migrations1734478975119 implements MigrationInterface {
  name = 'Migrations1734478975119';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`REL_4627550896111589a4da245dad\` ON \`students\``,
    );
    await queryRunner.query(
      `DROP INDEX \`REL_44855579fce3690c57ae8b1299\` ON \`students\``,
    );
    await queryRunner.query(
      `DROP INDEX \`REL_492f4df328e3a1db2296576cf7\` ON \`students\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE \`students\` DROP COLUMN \`levelId\``);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`level_id\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`department_id\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`program_id\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`school_id\` varchar(36) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP COLUMN \`program_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP COLUMN \`department_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` DROP COLUMN \`level_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`departmentId\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`schoolId\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
      `ALTER TABLE \`students\` ADD \`levelId\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(`DROP TABLE \`programs\``);
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_492f4df328e3a1db2296576cf7\` ON \`students\` (\`departmentId\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_44855579fce3690c57ae8b1299\` ON \`students\` (\`schoolId\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_4627550896111589a4da245dad\` ON \`students\` (\`levelId\`)`,
    );
    await queryRunner.query(
