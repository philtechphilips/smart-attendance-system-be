...
export class Migrations1734484091305 implements MigrationInterface {
  name = 'Migrations1734484091305';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` CHANGE \`userId\` \`user_id\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` CHANGE \`user_id\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
