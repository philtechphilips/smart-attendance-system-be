...
export class Migrations1734488228470 implements MigrationInterface {
  name = 'Migrations1734488228470';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`staffs\` ADD \`user_id\` varchar(36) NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`staffs\` ADD UNIQUE INDEX \`IDX_7953eac210a0e34a3e82a3c533\` (\`user_id\`)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_7953eac210a0e34a3e82a3c533\` ON \`staffs\` (\`user_id\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`staffs\` DROP INDEX \`IDX_7953eac210a0e34a3e82a3c533\``,
    );
    await queryRunner.query(`ALTER TABLE \`staffs\` DROP COLUMN \`user_id\``);
  }
}
