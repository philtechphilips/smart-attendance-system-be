...
export class Migrations1734483315745 implements MigrationInterface {
  name = 'Migrations1734483315745';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`IDX_e0208b4f964e609959aff431bf\` ON \`students\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`departments\` ADD \`code\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` CHANGE \`userId\` \`userId\` varchar(36) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`students\` CHANGE \`userId\` \`userId\` varchar(36) NULL DEFAULT 'NULL'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_e0208b4f964e609959aff431bf\` ON \`students\` (\`userId\`)`,
    );
  }
}
